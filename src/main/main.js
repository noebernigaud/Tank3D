        ...
        switch (level) {
            ...
            case (3): {
                ...
                for (var i = 0; i < (width - 80) / 30; i++) {
                    if (i < 7 || i > 12) {
                        walls.push(new Wall(30 + 30 * i, height / 3));
                        walls.push(new Wall(width - 60 - 30 * i, 2 * (height / 3) - 30));
                    }
                }
                for (var i = 0; i < (height - 80) / 30; i++) {
                    if (i < 3 || i > 8) {
                        walls.push(new Wall(width / 3, height - 60 - 30 * i));
                        walls.push(new Wall(2 * (width / 3) - 30, 30 + 30 * i));
                    }
                }
                break;
            }
